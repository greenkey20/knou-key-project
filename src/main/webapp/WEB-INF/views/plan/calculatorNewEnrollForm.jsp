...
<%--            </div>--%>
            ...
            <div align="center">
                <button type="button" onclick="location.href='mainPage.cm'">취소</button> <!--2023.7.24(월) 1810 나의 발견 = 계산 결과 화면으로부터 '새로 계산' 버튼 클릭해서 이 화면으로 넘어왔을 때, 이 버튼으로 '이전 화면'으로 가면(goBack() js 함수 호출) 이전 계산 결과 페이지로 감-->
