...
//        final RedirectView redirectView = new RedirectView("newPlanInsert.pl", true);
        ...
        // 2023.7.25(화) 21h45
        Map<String, Object> result = getCalendar();

        List<DateData> dateDataList = (List<DateData>) result.get("DateDataList");
//        Map<String, Integer> todayInfo = (Map<String, Integer>) result.get("todayInfo");
...
//    @RequestMapping(value = "calendar.pl", method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
    private Map<String, Object> getCalendar() {
...
//        return new Gson().toJson(dateDataList);
        mv.addObject(result).setViewName("plan/newPlanResultView");
        return mv;
    }
}
